...
public class JwtManager {
    ...
    public static final String CLAIM_USER_HASH = "userhash";
     ...
     */
    public String createToken( final String subject, final String userHash, final String role ) {
        final Instant now = Instant.now();
        final Date expiryDate = Date.from( now.plus( TOKEN_VALIDITY ) );
        return Jwts.builder()
                   .setSubject( subject )
                   .claim( CLAIM_USER_HASH, userHash)
